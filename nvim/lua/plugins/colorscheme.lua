return {
  {
    ...
    config = function(_, opts)
      ...
      -- CRITICAL: Clear @variable so it doesn't override more specific captures
      -- (@type, @constructor, @function.call all get stomped by @variable at same priority)
      -- Plain identifiers inherit fg from Normal (#fcfcfa) which is close enough
      set(0, "@variable", {})
